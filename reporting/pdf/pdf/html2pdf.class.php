...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        protected $_format           = 'F4';        // page format : A4, A3, ...
         ...
         */
        public function __construct($orientation = 'P', $format = 'Folio', $langue='fr', $unicode=true, $encoding='UTF-8', $marges = array(5, 5, 5, 8))
        {
