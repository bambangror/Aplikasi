...
?>
	<form name='hitung' Aksi='?n=hitung' method='POST'>
		...
		<tr>
			<td></td>
			<td colspan='5' width='130'><input type="submit" name="hok" value="" style="border: 0px; background-color:transparent" tabindex=1></td>
		</tr>
		</table>
		<!-- -->
	</form>
