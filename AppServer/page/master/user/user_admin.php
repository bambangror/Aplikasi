...
?>
	...
	<tr>
		<td height='10' width='720' ><div align='center'><h3>Data Pengguna</h3></div></td>
		<td><a href="?n=user_add" style="border: 1px solid #666; background-color:#fff">&nbsp;&nbsp;&nbsp;Tambah&nbsp;&nbsp;&nbsp;</button></a></td>
		<td width='4'></td>
...
<div id="MidPan">
		...
		<td width='115'><div align='center'><h3>Username</h3></div></td>
		...
		<div class="m2Pan">
<?php
		$q_user=mysql_query("SELECT users.*,roles.rname FROM users, roles WHERE users.rid=roles.rid");		  
...
?>
		...
		<td width='115'><div align='left'>	<?php echo $q_us['uname']; ?></div></td>
		<?php
		print "<td width='300' align='left'> $q_us[name] </td>";
		print "<td width='80' align='center'>$q_us[rname]</td>";
		print "<td width='16' align='center'><a href='./?n=user_e&&edit=$q_us[uid]'><img src='./misc/edit.gif'></a></td>";
		print "<td align='center'><a onclick=\"return confirm('Anda yakin akan menghapus $q_us[name] ?'); if (ok) return true; else return false\" href=./?n=user_e&&hapus=$q_us[uid]><img src='./misc/delete.gif'></a></td>"; ?>
		</tr>
<?php
		}
?>
