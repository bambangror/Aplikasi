...
?>
	...
	<tr>
		<td colspan='8' height='10'><div align='center'><h3>Modal Awal</h3></div></td>
		<td></td>
		<td width='80'></td>
	...
	<form name='modalawal' Aksi='?n=modalawal' method='POST'>
	<tr bgcolor="#F8F8F8">
		<td width='10'></td>
		...
		<td width='100'></td>
		<td width='80'><h3>Kassa</h3></td>
		<td width='3'>:</td>
		<td width='260'><input type="text" name="kassa">
		</td>
	...
	<div id="MidPan">
		...
		<td width='70' align='center'><h3>ID Modal</h3></td>
    	<td width='100' align='center'><h3>Tanggal</h3></td>
		<td width='90' align='center'><h3>No. Kassa</h3></td>
		<td width='120'align='center'><h3>Username</h3></td>
		<td width='100' align='center'><h3>Modal Awal</h3></td>
		...
		<div class="m2Pan">
<?php
		$qry=mysql_query("select modal.*,system.*,users.* from modal,system,users where 
						modal.s_id=system.s_id and modal.uid=users.uid and system.sno LIKE '%$keywords%' and 
						modate>='$tglawal' and modate<='$tglakhir'");		  
...
?>
		...
		<td width='70'><div align='right'>	<?php print $row['moid']?></div></td>
    	<td width='100'><div align='right'>	<?php print $row['modate']?></div></td>
		<td width='90'><div align='center'>	<?php print $row['sno']?></div></td>
		<td width='120'><div align='center'> 	<?php print $row['uname']?></div></td>
		<td width='100'><div align='right'><?php print number_format($row['momodal'])?></div></td>
		<?php
		print "<td width='16' align='center'><a href='./?n=modalawal_e&&edit=$row[moid]'><img src='./misc/edit.gif'></a></td>";?>
		</tr>
<?php
		}
?>
