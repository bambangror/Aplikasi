...
if (isset($_SESSION['loggedin']) && isset($_SESSION['rid']) && $_SESSION['rid']==1){	
	...
	} else {$tglawal=date('YYYY-mm-dd');$tglakhir=date('YYYY-mm-dd'); }
?>
	<table border=0 cellpadding=0 cellspacing=0 style="border:solid 0px #000;color:#000">
	<tr>
		<td colspan='8' height='10' width='120'><div align='center'><h3>Laporan Laba Penjualan</h3></div></td>
		<td><a href="?n=laplabapenjualan_c" style="border: 1px solid #666; background-color:#fff">&nbsp;&nbsp;&nbsp;Cetak&nbsp;&nbsp;&nbsp;</button></a></td>
		<td width='10'></td>
	...
	<form name='laplabapenjulan' Aksi='?n=laplabapenjulan' method='POST'>
	<tr bgcolor="#F8F8F8">
		<td width='10'></td>
	...
	<div id="MidPan">
    	...
    	<td width='80' align='center'><h3>No Nota</h3></td>
		<td width='70' align='center'><h3>Qty</h3></td>
		<td width='80'align='center'><h3>Nilai Beli</h3></td>
		<td width='80' align='center'><h3>Nilai Jual</h3></td>
		<td width='90'><div align='center'><h3>Laba Penjualan</h3></div></td>
		<td width='15'></td>
		</tr>
		</table>
		</div>
...
?>
		...
		<td width='80'><div align='right'>	<?php print $row['pjtgl']?></div></td>
    	<td width='80'><div align='left'>	<?php print $row['pjid']?></div></td>
		<td width='70'><div align='center'>	<?php print $row['pjtqty']?></div></td>
		<td width='80'><div align='right'> 	<?php print number_format($row['bbeli']*$row['pjtqty'])?></div></td>
		<td width='80'><div align='center'>	<?php print number_format($row['bjual']*$row['pjtqty'])?></div></td>
		<td width='90'><div align='right'> 	<?php print number_format(($row['bjual']*$row['pjtqty'])-($row['bbeli']*$row['pjtqty']))?></div></td>
		</tr>
<?php
		}
?>
