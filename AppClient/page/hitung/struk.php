...
<div id="pstruk">
	<form name='struk' action='?n=struk' method='POST'>
		...
		<tr>
			<td colspan='3' height='1' class="top"></td>
		</tr>
		<tr>
			<td width='260'><div align='center'><h3><?php print strtoupper($q_system['snama']) ?></h3></div></td>
		</tr>
		<tr>
			<td><div align='center'><?php print $q_system['salamat'] ?></div></td>
		</tr>
		</table>
		<table border=0 cellpadding=0 cellspacing=0 style="border:solid 0px #000;color:#000">
		<tr>
			<td colspan='5' height='1'><h3>-----------------------------------------------------------------<h3></td>
		</tr>
		<tr>
			<td width='10'></td>
		...
		<tr>
			...
			<td>Kasir/Kassa</td>
			<td>:</td>
			<td><?php print $_SESSION['uname'].'/'.$sno;?></td>
			<td></td>
		</tr>
		<tr>
			<td></td>
...
<?php
		$q_pjtr=mysql_query("select pjtransaksi.*,barang.* from pjtransaksi,barang 
							where pjtransaksi.bid=barang.bid and pjtaktif=1 and s_id='$sid' order by pjtno");		  
...
?>
		<tr>
			<td width='60'><div align='right'><?php print $q_pjt['bcode']?></div></td>
			<td width='8'></td>
...
?>
		<tr>
			<td></td>
			<td colspan='3' height='1'><h3>-------------------------------------------<h3></td>
			<td></td>
		</tr>
		</table>
		<table border=0 cellpadding=0 cellspacing=0 style="border:solid 0px #000;color:#000">
		...
		<tr>
			<td><div align='center'>Barang yang sudah dibeli tidak dapat<br>ditukar atau dikembalikan.</div></td>
		</tr>
		</table>
	</form>
</div>
<?php 
	SAVE_TR($_SESSION['uid']);
